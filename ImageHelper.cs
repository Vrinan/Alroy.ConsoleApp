...
namespace Alroy.ConsoleApp
{
    ...
    {
        #region 文本生成图片1
        public static void CreateImageOrig(string text)
        {
            string content = text;
            ...
            image.Save(@"E:\Reptile\dtImage1.jpg");
        }
        ...
        /// <param name="wid">宽-没用</param>
        /// <param name="high">高-没用</param>
        public static void CreateImage(string text, bool isBold, int fontSize, int wid, int high)
        {
            Font font;
            if (isBold)
            {
            ...
            //释放对象
            g.Dispose();
            image.Save(@"E:\Reptile\dtImage2.jpg");
        }
        #endregion
